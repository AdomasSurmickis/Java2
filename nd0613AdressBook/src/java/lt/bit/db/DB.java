...
public class DB {
    ...
    //tipo duombaze
    private static final List<Person> list = new ArrayList<>();//pakeista i public
    ...
    public static List<Person> getAll() {
        ...
        // conection conn = DriverManger.getConnection ("....");
        // result setas..
        //while (rs.next()){
        //Person p = new Person();
        ...
        //p.setSalary(rs.getBigDecimal(5));
        //l.add(p);
        //}
        //rs.close()
        //st.close()
    ...
    public static Person add(Person p) {
        if (!list.contains(p)) {
//            p.createId(); //galim trinti, nes neaktualu
            list.add(p);
            return p;
        }
        return null;
...
//                c.createId();
    ...
    public static Person update(Person p) {
        ...
        if (currentPerson != null) {
            ...
            currentPerson.setBirthDate(p.getBirthDate());//pagal save pasidaryt
